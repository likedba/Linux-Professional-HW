...
6. Затем можно создавать первый уровень абстракции - VG

`vgcreate otus /dev/sdb`

8. Создадим Logical Volume

`lvcreate -l+80%FREE -n test otus`

10. Посмотрим информацию о только что созданном Volume Group

`vgdisplay otus`

<img width="500" height="321" alt="image" src="https://github.com/user-attachments/assets/d75883b7-c074-4a49-b4e4-5759618b3da8" />

12. Посмотрим информацию о том, какие диски входит в VG:
...
14. Получим детальную информацию о LV
...
16. Создадим еще один LV из свободного места, но в мегабайтах:
...
18. Создадим на LV файловую систему и смонтируем его
...
13. Расширим VG, добавив в него диск
